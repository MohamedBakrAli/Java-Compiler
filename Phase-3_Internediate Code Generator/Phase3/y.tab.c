...
{
       0,   133,   133,   133,   142,   144,   154,   155,   156,   157,
     158,   159,   162,   176,   177,   178,   182,   188,   194,   213,
     228,   256,   286,   287,   288,   289,   309,   312,   340,   357,
     375
};
#endif
...
static const char *const yytname[] =
{
  ...
  "init_label", "goto", "if", "while", "for", "assignment", "expression",
  "system_print", "bool_expression", YY_NULLPTR
};
#endif
...
#line 257 "syntax.y" /* yacc.c:1646  */
    {
		...
		if(checkId(str))
		{
			...
			{
				cast(str, (yyvsp[-1].expr_type).sType);	// casting
			}
		}else{
...
#line 286 "syntax.y" /* yacc.c:1646  */
    {(yyval.expr_type).sType = FLOAT_T; addLineCode("ldc "+to_string((yyvsp[0].fval)));}
#line 1567 "y.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 287 "syntax.y" /* yacc.c:1646  */
    {(yyval.expr_type).sType = INT_T;  addLineCode("ldc "+to_string((yyvsp[0].ival)));}
